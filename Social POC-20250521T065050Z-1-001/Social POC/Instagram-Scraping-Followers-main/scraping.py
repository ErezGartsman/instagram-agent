...
class Instagram():
	...
	def get_followers(self, users, amount):
		...
		for user in users:
			...
			time.sleep(random.randrange(3, 5))
			followers_button = browser.find_element_by_partial_link_text("follower")#find_element_by_xpath('/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/div/ul/li[2]/button/div/span')
			count = str(amount)#followers_button.get_attribute('title')
			if ',' in count:
