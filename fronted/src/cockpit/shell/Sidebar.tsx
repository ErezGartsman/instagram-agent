...
export function Sidebar() {
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-line bg-surface">
      {/* Brand — the bronze mark is the one signature element up here. */}
      ...
      {/* Grouped nav: Work · Studio · Insight. Empty (all-flagged-off) groups
          are skipped so the rail never shows a dangling label. */}
      ...
      <div className="border-t border-line px-5 py-4">
        <p className="text-xs text-muted">Graphite Atelier · Sprint 5</p>
      </div>
    </aside>
  )
}
